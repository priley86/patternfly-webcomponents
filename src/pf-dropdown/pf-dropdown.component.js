...
>>>>>>> c74c5ba8e9d054182e505b6910f0add4dbe94c55
 */
...
=======
  ...
  attachedCallback() {
    ...
    this.insertBefore(this._dropdownTemplate.content, this.firstChild);
  ...
  _label() {
    ...
    let text = document.createTextNode(this.getAttribute('label'));
   ...
   */
  _getNode(selector) {
    let e1 = this.querySelector(selector);
    if (e1 === null) {
